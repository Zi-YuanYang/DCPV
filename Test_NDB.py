...
def test_binary_long_time(model):
    ...
    for j in range(ntrain):
        ...
        ### Hyper Para
        neg_code_temp = []
        neg_code_temp.append(featDB_train[j])
        neg_code = k_hidden_algorithm(neg_code_temp, r, p_list)
        print('generate neg bank')
...
def test_binary_long_time_dcpr(model):
    ...
    binary_path_rst = path_rst.replace("rst_test","rst_test_dcpr")
