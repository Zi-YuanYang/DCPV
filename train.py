...
from models.Hash_ccnet import hash_ccnet
from utils import *
...
if __name__== "__main__" :
    ...
    ##Training Path
    parser.add_argument("--train_set_file", type=str, default='./data/train_IITD.txt')
    parser.add_argument("--test_set_file", type=str, default='./data/test_IITD.txt')
    ...
    net = hash_ccnet(num_classes=num_classes,weight=weight_chan)
    best_net = hash_ccnet(num_classes=num_classes,weight=weight_chan)
    net.cuda()
